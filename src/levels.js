...
export const LEVELS = [
  ...
  },
  {
    id: 7,
    title: 'The Squeeze',
    tip: 'A tighter overhang than you\'ve seen before, and a stricter angle limit. Pull both handles up, but keep the approach and landing gentle.',
    gapStart: 280,
    gapEnd: 620,
    groundYLeft: 380,
    groundYRight: 380,
    ...
    channel: [
      { x: 0, minY: 40, maxY: 380 },
      { x: 280, minY: 40, maxY: 380 },
      { x: 450, minY: 260, maxY: 320 },
      { x: 620, minY: 40, maxY: 380 },
      { x: 900, minY: 40, maxY: 380 },
    ],
    initial: {
      p0: { x: 240, y: 380 },
  ...
  },
  {
    id: 8,
    title: 'Deep Valley',
    tip: 'A bigger drop this time, plus a ridge to clear in the middle. Dip low, rise for the ridge, then dip again before landing.',
    gapStart: 260,
    gapEnd: 680,
    groundYLeft: 340,
    groundYRight: 420,
    ...
    channel: [
      { x: 0, minY: 40, maxY: 340 },
      { x: 260, minY: 40, maxY: 340 },
      { x: 380, minY: 40, maxY: 440 },
      { x: 470, minY: 170, maxY: 250 },
      { x: 560, minY: 40, maxY: 460 },
      { x: 680, minY: 40, maxY: 420 },
      { x: 900, minY: 40, maxY: 420 },
    ],
    initial: {
      p0: { x: 220, y: 340 },
  ...
  },
  {
    id: 9,
    title: 'Steep Narrows',
    tip: 'The narrowest tunnel yet, and this bike barely tolerates any slope. Small, careful handle moves will get you through.',
    gapStart: 250,
    gapEnd: 650,
    groundYLeft: 380,
    groundYRight: 380,
    ...
    channel: [
      { x: 0, minY: 40, maxY: 380 },
      { x: 250, minY: 40, maxY: 380 },
      { x: 370, minY: 175, maxY: 265 },
      { x: 530, minY: 300, maxY: 390 },
      { x: 650, minY: 40, maxY: 380 },
      { x: 900, minY: 40, maxY: 380 },
    ],
    initial: {
  ...
  },
  {
    id: 10,
    title: 'Long Fall',
    tip: 'The landing is far below the takeoff, and there\'s a window to clear along the way. Keep every segment of the curve gentle — this bike won\'t forgive a steep patch.',
    gapStart: 220,
    gapEnd: 680,
    groundYLeft: 280,
    groundYRight: 440,
    maxAngle: 42,
    channel: [
      { x: 0, minY: 40, maxY: 280 },
      { x: 220, minY: 40, maxY: 280 },
      { x: 350, minY: 150, maxY: 260 },
      { x: 500, minY: 250, maxY: 400 },
      { x: 680, minY: 40, maxY: 440 },
      { x: 900, minY: 40, maxY: 440 },
    ],
    initial: {
      p0: { x: 180, y: 280 },
      p1: { x: 300, y: 260 },
  ...
  },
  {
    id: 11,
    title: 'The Gauntlet',
    tip: 'Everything at once, cranked up: a big drop, a narrow window, and this bike\'s strictest angle limit yet. Take your time shaping the approach and landing.',
    gapStart: 220,
    gapEnd: 700,
    groundYLeft: 320,
    groundYRight: 440,
    maxAngle: 40,
    channel: [
      { x: 0, minY: 40, maxY: 320 },
      { x: 220, minY: 40, maxY: 320 },
      { x: 360, minY: 140, maxY: 250 },
      { x: 490, minY: 300, maxY: 460 },
      { x: 610, minY: 230, maxY: 340 },
      { x: 700, minY: 40, maxY: 440 },
      { x: 900, minY: 40, maxY: 440 },
    ],
    initial: {
      p0: { x: 180, y: 320 },
