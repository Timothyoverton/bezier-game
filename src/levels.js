...
export const LEVELS = [
  ...
  },
  {
    id: 5,
    title: 'Narrow Tunnel',
    tip: 'Tight squeeze — rise up through the first window, then dip down through the second. Pull one handle up and the other down to bend the curve into shape.',
    gapStart: 250,
    gapEnd: 650,
    groundYLeft: 380,
    groundYRight: 380,
    ...
    channel: [
      ...
      { x: 370, minY: 150, maxY: 290 },
      { x: 530, minY: 290, maxY: 430 },
  ...
  },
  {
    ...
    channel: [
      ...
      { x: 350, minY: 130, maxY: 300 },
      { x: 480, minY: 320, maxY: 480 },
      { x: 610, minY: 200, maxY: 360 },
